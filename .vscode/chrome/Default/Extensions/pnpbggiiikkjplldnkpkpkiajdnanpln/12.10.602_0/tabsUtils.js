...
(
    function(tabId, selectInfo)
    {
        ...
        if (tabInfo !== undefined)
        {
            ...
            markSelected(tabId, tabInfo.windowId);
        }
    }
);
...
function sendDebuggerCommand(tabId, command, paramsJSON)
{
    ...
    try {
        ...
        if (tabInfo && (command == "Page.setDeviceMetricsOverride"))
            tabInfo.deviceScaleFactor = params.deviceScaleFactor;
    }
    catch (e) {
        console.trace(e)
    }
